...
Section:NewButton("Revive All", "ButtonInfo", function()
    print("Revived Everyone")
    local player = game.Players.LocalPlayer

for _,v in pairs(game.Players:GetPlayers()) do

game:GetService("ReplicatedStorage").Ressurection:FireServer(v.Character)
end
end)
...
if table.find(IgnoreList, v.Name) then 
    ...
    game:GetService("ReplicatedStorage").FreezeEvent:FireServer(v.Character)
...
local Section = Tab6:NewSection("Discord: https://discord.gg/hQekChjZP3")
